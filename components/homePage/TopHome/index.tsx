...
export const TopHome = () => {
	useEffect(() => {
		...
		if (home) home.style.backgroundImage = "url('img/hero-bg.svg')"
	}, [])
	return (
		<section id='home' className=' -mt-10 flex pb-20 pt-28 lg:pb-36 lg:pt-32 bg-no-repeat bg-cover bg-center justify-center w-full '>
