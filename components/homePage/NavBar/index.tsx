		...
		<nav className=' w-full py-4 transition-all duration-300 '>
			...
			>
				...
				<Link href='/bankApp' aria-label='Go to my bank app'>
					<button className=' inline-flex lg:hidden mt-2  items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-lime-600 to-blue-500 group-hover:from-lime-800 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800'>
						<span className='relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0'>
							BANK APP
						</span>
					</button>
